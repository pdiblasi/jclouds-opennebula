...
public class HISTORY {
    ...
    public HISTORY.VM getVM() {
        return vm;
    }
    
    public void setVM(HISTORY.VM value) {
        this.vm = value;
    }
    ...
    public static class VM {
        ...
        protected HISTORY.VM.PERMISSIONS permissions;
        ...
        protected Object historyrecords;
        @XmlElement(name = "SNAPSHOTS")
        protected List<HISTORY.VM.SNAPSHOTS> snapshots;
        ...
        public HISTORY.VM.PERMISSIONS getPERMISSIONS() {
            return permissions;
        }
        
        public void setPERMISSIONS(HISTORY.VM.PERMISSIONS value) {
        ...
        public Object getHISTORYRECORDS() {
            return historyrecords;
        }
        
        public void setHISTORYRECORDS(Object value) {
            this.historyrecords = value;
        }
        
        public List<HISTORY.VM.SNAPSHOTS> getSNAPSHOTS() {
            if (snapshots == null) {
                snapshots = new ArrayList<HISTORY.VM.SNAPSHOTS>();
            }
        ...
        public static class SNAPSHOTS {
            ...
            protected List<HISTORY.VM.SNAPSHOTS.SNAPSHOT> snapshot;
            ...
            public List<HISTORY.VM.SNAPSHOTS.SNAPSHOT> getSNAPSHOT() {
                if (snapshot == null) {
                    snapshot = new ArrayList<HISTORY.VM.SNAPSHOTS.SNAPSHOT>();
                }
